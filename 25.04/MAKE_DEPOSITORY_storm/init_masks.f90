...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE init_masks
    ...
    CHARACTER (LEN=varnamelength), DIMENSION(:,:), ALLOCATABLE ::  do_mask      !< list of output variables
    CHARACTER (LEN=varnamelength), DIMENSION(:,:), ALLOCATABLE ::  do_mask_user !< list of user-specified output variables
...
!-- Allocation and initialization
    ALLOCATE( do_mask(max_masks,100) )
    ALLOCATE( do_mask_user(max_masks,100) )
...
!--    Local arrays can be relocated directly.
    ...
    DEALLOCATE( do_mask, do_mask_user, tmp_array )
!
