...
!--             done in the parameter-list in rrd_global.
       ...
       CALL wrd_write_string( 'cut_cell_topography' )
       WRITE ( 14 )  cut_cell_topography
    ...
    WRITE ( 14 )  dt_pr_1d
       ...
       CALL wrd_write_string( 'nesting_coupling_time' )
       WRITE ( 14 )  nesting_coupling_time
...
!--    There is no module procedure for CHARACTER arrays
       ...
       CALL wrd_mpi_io( 'nesting_coupling_time', nesting_coupling_time )
