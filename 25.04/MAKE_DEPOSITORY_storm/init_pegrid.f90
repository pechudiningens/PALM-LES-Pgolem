...
!-- Nested conditions have been automatically set in parin.
...
!-- Indices for direct transpositions z --> y (used for calculating spectra)
    ...
    !$ACC ENTER DATA &
    !$ACC COPYIN(nyn_z_pe, nys_z_pe, nxl_y_pe, nxr_y_pe, nny_pe, nzb_x_pe) &
    !$ACC COPYIN(nzt_x_pe, nxr_pe, nxl_pe) IF(enable_openacc)
