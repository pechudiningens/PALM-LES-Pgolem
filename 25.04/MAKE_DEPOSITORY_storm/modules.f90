...
!--------------------------------------------------------------------------------------------------!
 MODULE averaging
    ...
    REAL(wp), DIMENSION(:,:,:), ALLOCATABLE, TARGET ::  clay_av       !< avg. clay mass concentration
    REAL(wp), DIMENSION(:,:,:), ALLOCATABLE, TARGET ::  diss_av       !< avg. tke dissipation rate
    REAL(wp), DIMENSION(:,:,:), ALLOCATABLE, TARGET ::  dust_av       !< avg. dust mass concentration
    ...
    REAL(wp), DIMENSION(:,:,:), ALLOCATABLE, TARGET ::  silt_av       !< avg. silt mass concentration
...
!--------------------------------------------------------------------------------------------------!
 MODULE control_parameters
    ...
    CHARACTER (LEN=12)   ::  user_interface_required_revision = '2.0'     !< required user-interface revision number (only major number is checked)
    ...
    REAL(wp) ::  pt_vertical_gradient(12) = 0.0_wp                 !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    REAL(wp) ::  pt_vertical_gradient_level(12) = HUGE( 1.0_wp )   !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    REAL(wp) ::  q_vertical_gradient(12) = 0.0_wp                  !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    REAL(wp) ::  q_vertical_gradient_level(12) = HUGE( 1.0_wp )    !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    ...
    REAL(wp) ::  s_vertical_gradient_level(12) = HUGE( 1.0_wp )    !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    ...
    REAL(wp) ::  ug_vertical_gradient(12) = 0.0_wp                 !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    REAL(wp) ::  ug_vertical_gradient_level(12) = HUGE( 1.0_wp )   !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    REAL(wp) ::  vg_vertical_gradient(12) = 0.0_wp                 !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    REAL(wp) ::  vg_vertical_gradient_level(12) = HUGE( 1.0_wp )   !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    ...
    REAL(wp) ::  subs_vertical_gradient(12) = 0.0_wp               !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
    REAL(wp) ::  subs_vertical_gradient_level(12) = HUGE( 1.0_wp ) !< namelist parameter (dimensioned with 12 to store two extra points at bottom/top)
...
!--------------------------------------------------------------------------------------------------!
 MODULE statistics
    ...
    INTEGER(iwp) ::  pr_total               !< total number of output profiles (including modules)
    INTEGER(iwp) ::  pr_total_modules       !< total number of output profiles from specific modules
