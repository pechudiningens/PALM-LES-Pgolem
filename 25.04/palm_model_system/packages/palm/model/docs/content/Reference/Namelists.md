...
---
## **^^Damping Parameters^^**
{{ include_palm_namelist('damping_parameters') }}

---
## **^^Dust Emission and Transport Parameters^^**
{{ include_palm_namelist('det_parameters') }}
...
{{ include_palm_namelist('flow_control_parameters') }}
...
---
## **^^Surface Data Output Parameters^^**
...
{{ include_palm_namelist('uv_radiation_parameters') }}
