...
!--          For sake of consistency, set also top boundary condition.
    ...
    ENDIF
!
!-- Before mass-flux conservation is invoked for the very first time, the outflow boundary for the
!-- u-component needs to be initialized too.
    IF ( bc_radiation_r )  u(:,:,nxr+1) = u(:,:,nxr)
!
