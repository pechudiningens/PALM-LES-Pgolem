...
!-- Indicies of input attributes in building_indoor.
    ...
    INTEGER(iwp) ::  ind_qint_high           = 13  !< index in input list for additional internal heat gains dependent on occupancy of the room
...
!-- Indices of input attributes in building_pars for (above) ground floor level
    ...
    INTEGER(iwp) ::  ind_tc4_agfl          = 137  !< index in input list for thermal conductivity at fourth wall layer, above ground floor level
    INTEGER(iwp) ::  ind_tc4_gfl           = 139  !< index in input list for thermal conductivity at fourth wall layer, ground floor level
...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE usm_timestep
    ...
    REAL(wp), DIMENSION(nzb_wall:nzt_wall) ::  max_dt_green_column  !< allowed timestep for each vertical level of a green surface column
