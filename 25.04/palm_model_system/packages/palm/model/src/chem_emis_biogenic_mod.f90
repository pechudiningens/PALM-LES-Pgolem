...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE emis_nc_get_vegetation_data ( )
    ...
    CALL get_variable( ncid, var_soil_type, soil_type, nxl, nxr, nys, nyn, nbgp=0 )
    CALL get_variable( ncid, var_tree_type, tree_type, nxl, nxr, nys, nyn, 0, zlad-1, nbgp=0 )
    CALL get_variable( ncid, var_vegetation_type, vegetation_type, nxl, nxr, nys, nyn, nbgp=0 )
    CALL get_variable( ncid, var_patch_height, patch_height, nxl, nxr, nys, nyn, nbgp=0 )
    CALL get_variable( ncid, var_vegetation_height, vegetation_height, nxl, nxr, nys, nyn, nbgp=0 )
    CALL get_variable( ncid, var_vegetation_pars, vegetation_pars, nxl, nxr, nys, nyn,             &
                       0, nvegetation_pars-1, nbgp=0 )
    CALL get_variable( ncid, var_lad, lad, nxl, nxr, nys, nyn, 0, zlad-1, nbgp=0 )
    CALL get_variable( ncid, var_bad, bad, nxl, nxr, nys, nyn, 0, zlad-1, nbgp=0 )
