...
!--       If nesting is activated in a restart for the first time, it is an initial run for the
!--       childs, and they have to read the respective namelist file for the initial run, although
!--       it is a restart run for the root domain.
          root_model = .TRUE.
#if defined( __parallel )
